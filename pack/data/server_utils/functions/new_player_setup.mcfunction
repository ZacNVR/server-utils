...
execute as @e[type=marker,tag=player_tracker] if score @s owner_id matches @a[tag=server_utils_cursor0,limit=1] player_id run tag @a[tag=server_utils_cursor0,limit=1] add server_utils_cursor2
