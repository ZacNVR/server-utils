...
execute as @e[type=marker,tag=server_utils,tag=player_tracker] unless score @s owner_id = @p[tag=new_player] player_id run function server_utils:spawn_player_marker
