...
execute as @s[tag=server_utils_cursor0,tag=!server_utils_cursor1] run function server_utils:internal/new_player_setup

function server_utils:internal/store_username
