...
execute if score @s[tag=server_utils_cursor2] player_id matches 1.. run function server_utils:internal/new_id

#Runs for entirely new players
execute unless score @s player_id matches 1.. run function server_utils:internal/new_id

tag @s[tag=server_utils_cursor2] remove server_utils_cursor2
function server_utils:internal/spawn_player_marker