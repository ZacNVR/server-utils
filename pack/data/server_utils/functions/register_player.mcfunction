...
execute as @e[type=marker,tag=player_tracker] if score @s owner_id = @p[tag=current_player] run scoreboard players operation @s owner_registration_level = registration_level server_utils_config
