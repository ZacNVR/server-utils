...
tellraw @s [{"text":"","color":"gold"},{"text":" <<< ","clickEvent":{"action":"run_command","value":"/trigger list_all_ids set -2"},"hoverEvent":{"action":"show_text","contents":"Previous page"}},[{"text":"Page ","color":"yellow"},{"score":{"objective":"id_list_page","name":"@s"}}," of ",{"score":{"objective":"server_utils_var","name":"id_list_pages"}}],{"text":" >>> ","clickEvent":{"action":"run_command","value":"/trigger list_all_ids set -1"},"hoverEvent":{"action":"show_text","contents":"Next page"}}]
